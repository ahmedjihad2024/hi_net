        ...
        child: SizedBox(
          ...
          child: Column(
            children: [
              ...
              24.verticalSpace,
              Image.asset(ImagesM.chat, width: 106, height: 106.w).animatedOnAppear(3, SlideDirection.down),
              Padding(
                            ...
                            builder: (context, value, child) {
                              return FastCountryCodeButton(
                                ...
                                onSelectionChange: (cCode) {
                                  ...
                                  countryCodeNotifier.value = cCode.countryCode;
                                },
                              );
                            },
                          ),
              ...
              SizedBox(height: 15.w + MediaQuery.of(context).padding.bottom),
            ],
          ),
        ),
      ),
