                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          '⚠️ Copy this information and enter details manually to install your eSIM. Make sure your device has a stable internet connection before installing.',
                          style: TextStyle(
                            fontSize: 12.sp,
    ...
    return Column(
      ...
      children: [
        ...
        _buildInstructionItem(
          context,
          4,
          'Enter the SM-DP+ Address & Activation Code available on the Airalo app by copying it, tap ',
          ['Connect'],
          ', then tap ',
          ['Confirm'],
          '.',
